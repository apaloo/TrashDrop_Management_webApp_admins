-- Updated Database Fix for TrashDrop Admin Portal
-- This fixes all remaining database schema issues and handles existing constraints

-- ============================================================================
-- 1. CHECK AND FIX ALERTS FOREIGN KEY CONSTRAINTS
-- ============================================================================
...
BEGIN
    ...
    IF NOT EXISTS (
        SELECT 1 FROM information_schema.table_constraints 
        WHERE constraint_name = 'alerts_creator_fkey' 
        AND table_name = 'alerts'
    ) THEN
        ALTER TABLE public.alerts 
...
-- ============================================================================
-- 6. FORCE SCHEMA CACHE REFRESH (CRITICAL)
-- ============================================================================

-- Refresh the schema cache to ensure Supabase recognizes all relationships
