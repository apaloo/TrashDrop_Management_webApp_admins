...
/* Renders an ISO date (YYYY-MM-DD) as e.g. "12 April 2026". Parsed as UTC so
   the displayed day can't drift by one in negative-offset timezones. */
...
const BlogPage = () => {
  ...
  return (
    <PublicPageLayout>
              ...
              <Link key={post.slug} to={`/blog/${post.slug}`} style={{ textDecoration:'none' }}>
                <article style={{ background:'rgba(255,255,255,0.03)', border:'1px solid rgba(255,255,255,0.07)', borderRadius:20, padding:'32px 28px', height:'100%', transition:'all 0.25s', display:'flex', flexDirection:'column', boxSizing:'border-box' }}
                  ...
                  <div style={{ display:'flex', alignItems:'center', justifyContent:'space-between', marginBottom:20 }}>
                    ...
                    <span style={{ ...FF.label, fontSize:11, color:TD.sage, fontWeight:600 }}>
      ...
      <RelatedLinks links={['/how-it-works', '/users', '/illegal-dumping', '/about']} />
    </PublicPageLayout>
  );
};
